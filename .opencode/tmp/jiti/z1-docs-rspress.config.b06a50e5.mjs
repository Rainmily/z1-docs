"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _core = await jitiImport("@rspress/core");
var _auth = await jitiImport("./plugins/auth");
var _path = _interopRequireDefault(await jitiImport("path"));
var _url = await jitiImport("url");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}

const _filename = (0, _url.fileURLToPath)("file:///Users/fan/www/AI/z1-docs/rspress.config.ts");
const _dirname = _path.default.dirname(_filename);

// 生产用 /auth-api（nginx 已代理到 Express）；本地开发用 localhost:3001
const apiBase = process.env.AUTH_API_BASE || '/auth-api';var _default = exports.default =

(0, _core.defineConfig)({
  root: 'docs',
  themeDir: _path.default.join(_dirname, 'theme'),
  title: '掌上乾坤-赋能中心',
